...
const extToMimeType = Object.fromEntries(Object.entries(mimeDB).flatMap(([type, obj]) => "extensions" in obj ? obj.extensions.map((ext) => [ext, type]) : []));
function fileToOSPath(file) {
...
async function list(path) {
  ...
  const result = await Promise.all(dirlist.map((name) => {
...
export { exists as a, ensureFolder as e, getInfo as g, isWithin as i, list as l, read as r };
