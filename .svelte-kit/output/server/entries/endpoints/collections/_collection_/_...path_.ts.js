import { s as siteConfig } from "../../../../chunks/site-config-b274994e.js";
...
Object.fromEntries(Object.entries(mimeDB).flatMap(([type, obj]) => "extensions" in obj ? obj.extensions.map((ext) => [ext, type]) : []));
